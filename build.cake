...
var libraryName = "Cake.Email.Common";
var gitHubRepo = "Cake.Email.Common";

var testCoverageFilters = new[]
{
	"+[Cake.Email.Common]*",
	"-[Cake.Email.Common]Cake.Email.Common.Properties.*",
	"-[Cake.Email.Common]Cake.Email.Common.Models.*",
	"-[Cake.Email.Common]*System.Text.Json.SourceGeneration*"
};
